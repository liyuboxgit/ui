...
jQuery.validator.addMethod("telephone",function(value,element){
	...
	return this.optional(element) || (/^[+]{0,1}(\d){0,4}[ ]?([-]?((\d)|[ ]){7,12})$/.test(value));
},"只能是合法电话");
...
@athor:周小建
@time:2007-10-15 09:00:00
@description:纳税人识别号检验方法
*/
jQuery.validator.addMethod("nsrsbh",function(value,element){
	//return this.optional(element) || (/^[a-zA-Z0-9]{3,12}$/.test(value));
	return this.optional(element) || /^[a-zA-Z0-9]{15,15}$/.test(value) || /^[a-zA-Z0-9]{18,18}$/.test(value) || /^[a-zA-Z0-9]{20,20}$/.test(value);
},"纳税人识别号必须是15位或18位或20位");
...
@athor:周小建
@time:2007-10-15 09:00:00
@description:验证小数点后长度限制
*/
jQuery.validator.addMethod("decimalDigits",function(value,element,param){
	//return this.optional(element) || (/^[a-zA-Z0-9]{3,12}$/.test(value));
